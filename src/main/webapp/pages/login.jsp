...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="<c:url value="/user/login"/>" method="post" id="myform">
            <div class="form-group has-feedback">
                <input type="text" id="name" name="name" class="form-control" placeholder="账户">
            ...
            <div class="row">
                ...
                <!-- /.col -->
                <div class="col-xs-4">
                    <button type="submit" class="btn btn-primary btn-block btn-flat" id="login" value="登录">登录</button>
                </div>
                <!-- /.col -->
            </div>
        </form>
